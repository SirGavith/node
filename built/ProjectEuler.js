...
class ProjectEuler {
    ...
    static P30() {
        // let nums: bigint[] = []
        // let i = 2n;
        console.log(new GRange(2n, 1000000n).Array
            .filter(i => i.IntDigits()
            .map(n => BigInt(n ** 5))
            .Sum() == i).Sum());
        // while (i < 1_000_000) {
    ...
    static P34() {
        ...
        // }
        // console.log(nums.Sum())
        console.log(new GRange(3n, 1000000n).Array
            .filter(i => i.IntDigits()
    ...
    static P39() {
        let validtriangles = [];
        let frequencies = {};
        GRange.DoubleForRange(new GRange(1, 500), new GRange(1, 500), (a, b) => {
    ...
    static P80() {
        console.log(GMath.Comprehend(i => BigInt(i.SqrtDigits(100).SumDigits()), new GRange(1n, 100n)).Sum());
    }
    static P101() {
